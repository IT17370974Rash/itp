...
CREATE TABLE `maintanance` (
  ...
  `maintaiin_type` varchar(45) DEFAULT NULL,
  `m_part` varchar(45) DEFAULT NULL,
  `m_cost` double DEFAULT NULL,
  `fid` int(11) DEFAULT NULL,
  PRIMARY KEY (`mid`),
  KEY `fk_maintanence_idx` (`fid`),
  CONSTRAINT `fk_maintanence` FOREIGN KEY (`fid`) REFERENCES `finance` (`fid`)
